...
24. A instanceof B: 检查对象类型;
      ...
      function typeOf(obj) { // 判断类型 [object xxxxx] 根据字符串截取
...
26. 浅拷贝: 拷贝一层
    ...
    function deepCopy(obj) {  // 递归深拷贝 只考虑普通对象属性，不考虑内置对象（Date, Exp）和函数。
...
101. react
  1. react hooks和class相比优点
          ...
          1. react-hooks让代码的逻辑性更强，可以抽离公共的方法，公共组件。
  ...
  vue
        ...
        6. 声明周期
          ...
          beforeCreate: 实例化Vue;还没有初始化data和methods
